...
//**********登入**********/
bool Login  (1:LoginAccount info), //登入
bool Logout (1:string loginID),    //登出
...
bool SendVoiceData  (1:string media_id, 2:string buffer),       //发送对讲音频
...
//**********媒体通知**********/
void MediaStarted (1:string device_id, 2:string media_id), //媒体连接成功
void MediaFinish  (1:string device_id, 2:string media_id), //结束通知
void MediaData    (1:string device_id, 2:string media_id, 3:MediaPackage data), //媒体数据
//**********报警通知**********/
void xAlarmNotify (),//
//test
